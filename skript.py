...
class ConsolePdfBuilder:
    ...
    def PrintWelcomeScreen(self):
        print("\n   ||-------------------------------------------------------------||")
        print("   ||        PDF-Gestalter für *****-Einstellungen Leipzig        ||")
    ...
    def buildPdf(self, listTableData, mDictValuePairs):
        ...
        for i in listTableData:
            ...
            # create a dummy cell to get the position for the second cell under the company-logo
